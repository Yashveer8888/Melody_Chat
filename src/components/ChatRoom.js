...
const socket = io("https://melody-chat-backend.onrender.com");
...
function ChatRoom() {
  ...
  useEffect(() => {
    const fetchMessages = async () => {
      try {
        const response = await fetch(`https://melody-chat-backend.onrender.com/api/room-messages/${roomId}`);
  ...
  const sendMessage = async () => {
    ...
    try {
      const response = await fetch("https://melody-chat-backend.onrender.com/api/send-message", {
        method: "POST",
  ...
  const closeRoom = async () => {
    try {
      const response = await fetch(`https://melody-chat-backend.onrender.com/api/close-room/${roomId}`, {
        method: "DELETE",
      });
